...
type EduGroup struct {
	...
	SourceSubgroupID int        `json:"source_subgroup_id" db:"source_subgroup_id"`
	IsSubgroup       bool       `json:"is_subgroup" db:"is_subgroup"`
...
type EduGroupDao struct {
	...
	ParentGroupID    sql.NullString `db:"parent_group_id" json:"parent_group_id"`
	Name             sql.NullString `db:"name" json:"name"`
	Source           sql.NullString `db:"source" json:"source"`
	SourceGroupID    sql.NullInt32  `db:"source_group_id" json:"source_group_id"`
	SourceSubgroupID sql.NullInt32  `db:"source_subgroup_id" json:"source_subgroup_id"`
	IsSubgroup       sql.NullBool   `db:"is_subgroup" json:"is_subgroup"`
...
func (e *EduGroupDao) ToEduGroup() *EduGroup {
	eg := &EduGroup{
		...
		SourceSubgroupID: int(e.SourceSubgroupID.Int32),
		IsSubgroup:       e.IsSubgroup.Bool,
	...
	if e.ParentGroupID.Valid {
		eg.ParentGroupID, _ = uuid.Parse(e.ParentGroupID.String)
	}
