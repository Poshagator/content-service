...
const file_schedule_proto_rawDesc = "" +
	...
	"\fSyncSchedule\x12\x1d.schedule.SyncScheduleRequest\x1a\x1e.schedule.SyncScheduleResponseBFZDgithub.com/poshagator/content-service/pkg/api/grpc/schedule;scheduleb\x06proto3"
